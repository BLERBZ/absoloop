...
| [shortcuts.md](shortcuts.md) | Keyboard + Codex Micro shortcuts |
| [assets/BRAND.md](assets/BRAND.md) | Logos and palette |
| [github-profile/SETUP.md](github-profile/SETUP.md) | Publish the org/personal GitHub profile |

Start at the root [README](../README.md). Contributors: [CONTRIBUTING.md](../CONTRIBUTING.md).
